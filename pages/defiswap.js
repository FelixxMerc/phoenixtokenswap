...
export default function Defiswap() {
    ...
    const config = {
      apiKey: "S0_WbucKb2i0RfMUFsuw5-iQbsGLX9hB",
...
async function swapit() {
  ...
  return (
    <Grid.Container gap={1} justify='center'>
                    <Button rounded color="primary" onPress={connect} css={{boxShadow:'0px 0px 4px #ff0000', marginTop:'100px', backgroundColor:"#FFD700"}}>
                <Text
                  css={{ color: "#FF0000" }}
                  size={16}
                  weight="bold"
      ...
      <Row justify="center" >
      <Grid sm={4} css={{textShadow: "0px 0px 10px #ff0000"}}>
    <Card 
      variant="bordered"  css = {{backgroundColor:"#FFD700", }}
    >
      <Card.Header>
        <Row >
          <Col >
            ...
            <Avatar
              src="phoenix.png"
              css={{ size: "$40", margin:"20px" }}
              zoomed
              bordered
              color="#ff0000"
            />
          </Col>
          <img src="blackethereumlogo.png" width={"30%"} />
        </Row>
      </Card.Header>
      <Text
        h3={true}
      ...
      >
          ...
          <Text type='text'
            size="$4xl"
            css={{fontFamily:'SF Pro Display',color:'white',
            textShadow:"0px 0px 3px #ff0000", ml:'$2'}} 
            className="number"
      ...
      <Card isPressable css={{backgroundColor:'#FFD700'}} onPress={swapit}>
                <Text
                  css={{display:'flex',justifyContent:'center',color: "red", textShadow:'0px 0px 5px #ff0000' }}
                  size="$3xl"
                  weight="bold"
                  transform="uppercase">
                 SWAP !
      ...
      <Card
        css={{
          borderTop: "$borderWeights$light solid rgba(255, 255, 255, 0.2)", background:"#ff0000"
        }}
      >
          <Row justify="center" css={{mt:'$2'}}>
            ...
            <Text
              size={20}
              id="wallet-address"
              css={{ color: "#ff0000", textShadow: "0px 0px 3px #000000",marginRight: "$2" }}
            />
            </Row>
      </Card>
      </Row>
